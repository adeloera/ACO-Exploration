...
temp_2017 <- county_lvl_aco_2017 %>%
  ...
  ungroup() %>%
  select(state_name, county_name, state_and_county_fips_code, beneficiaries_with_part_a_and_part_b, ffs_beneficiaries, ma_beneficiaries, aco_benes, year, geometry) %>%
