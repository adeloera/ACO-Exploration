...
##Visual: 
I hope to eventually present an animation showing the ACO beneficiary population by county over the four year window of the data. For now I have four static maps, one for each year. 
...
```{r dynamic_visual, echo = FALSE, cache = TRUE}
#I will now create an animation showing the change in the ACO beneficiary population at the county level over four years. 
#That begins with the dataset I made above. 
...
#Here I write my master file into an rds file to be used elsewhere.

write_csv(master, "ACO_exploration/master_file.csv")
